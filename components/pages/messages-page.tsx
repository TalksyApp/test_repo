...
export default function MessagesPage() {
    ...
    return (
        <div className="w-full h-full relative overflow-hidden">
            ...
            <div className="w-full h-[calc(100vh-40px)] max-w-[1600px] mx-auto pt-8 pb-8 flex gap-6 animate-in fade-in duration-500 px-6 relative z-10">

                {/* --- LEFT: CONTACT LIST --- */}
                <div className={`w-full md:w-[380px] flex-shrink-0 flex flex-col bg-black/20 backdrop-blur-2xl border border-white/10 rounded-[32px] overflow-hidden ${selectedId ? 'hidden md:flex' : 'flex'}`}>
                ...
                {/* --- RIGHT: CHAT WINDOW --- */}
                <div className={`flex-1 bg-black/20 backdrop-blur-2xl border border-white/10 rounded-[32px] flex flex-col overflow-hidden relative ${!selectedId ? 'hidden md:flex' : 'flex'}`}>

                    {selectedId && activeContact ? (
                        <>
                            {/* Chat Header (Cleaned up - No Calls) */}
                            <div className="p-6 border-b border-white/5 flex justify-between items-center bg-black/40 backdrop-blur-xl z-10">
                            ...
                            <div className="p-5">
                                <div className="p-2 pl-4 bg-[#0a0a0a]/60 border border-white/10 rounded-full flex items-center gap-2">
